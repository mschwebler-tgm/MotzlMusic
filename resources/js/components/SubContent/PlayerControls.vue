        ...
        <v-layout column>
            <v-flex grow>
                <v-layout justify-center>
                    <v-flex shrink>
                        <v-btn flat icon aria-label="Play previous">
                            <v-icon @click="playPrevious">skip_previous</v-icon>
                        </v-btn>
                        <v-btn flat icon :loading="loading" @click="togglePlay" :aria-label="playing ? 'Pause' : 'Play'">
                        ...
                        <v-btn flat icon aria-label="Play next">
